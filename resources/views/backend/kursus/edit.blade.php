      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <a href="{{route('peserta.show', $kursus->peserta->id)}}" class="btn btn-primary"><i class="fas fa-undo"></i> Kembali</a> 
            </span>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	     			...
	     			<div class="row">
	     				<div class="col-12">
	     					<div class="form-group">
			                  <label>Peserta Kursus</label>
			                  <input name="peserta_id" type="text" value="{{$kursus->peserta->id}}" class="form-control" readonly />
			                </div>
	     				</div>
	     				...
	     				<div class="col-12 col-md-6">
	     					<div class="form-group">
			                  ...
			                  <select name="program_id" class="form-control select2" style="width: 100%;">
			                    ...
			                    <option value="{{$prog->id}}" {{ $kursus->program->id == $prog->id ? 'selected' : '' }} > {{$prog->program}}</option>
			                    @endforeach
			                  </select>
			                  	@error('program_id')
	     				...
	     				<div class="col-12 col-md-6">
	     					<div class="form-group">
			                  ...
			                  <select name="instruktur_id" class="form-control select2" style="width: 100%;">
			                    ...
			                    <option value="{{$ins->id}}" {{ $kursus->instruktur->id == $ins->id ? 'selected' : '' }} > {{$ins->nama}}</option>
			                    @endforeach
			                  </select>
			                  	@error('instruktur_id')
			                        <span class="invalid-feedback" role="alert">
